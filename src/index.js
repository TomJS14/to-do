...
newListForm.addEventListener("submit", e => {
    ...
    if (projectName == null || projectName === "") {return} //early return if blank
...
newTaskForm.addEventListener("submit", e => {
    ...
    const taskDate = ""
    if (taskName == null || taskName === "") {return} //early return if blank
...
function createTask(name, date) {
    return { id: Date.now().toString(), name: name, complete: false, dueDate: date }
}
